...
export { default as OneOfSelectRenderer } from './OneOfSelectRenderer.vue';
...
import { entry as oneOfSelectRendererEntry } from './OneOfSelectRenderer.vue';
